...
class App extends React.Component {
  ...
  closeAllPopups() {
    console.log('Закрыть все попапы')
    ...
    return (
      <div className="App">
        ...
        <PopupWithForm
          ...
          children={
            this.state.isEditProfilePopupOpen === true ? `<div class="popup__input-box">
        <input id="input-name"
               type="text"
               name="user"
               placeholder="Имя"
        ...
        <span id="input-subtitle-error"
              ...
              this.state.isAddPlacePopupOpen === true ? `<div class="popup__input-box">
      ...
      <span id="input-url-error" class="popup__error "></span>
                ...
                this.state.isEditAvatarPopupOpen === true ? `<div class="popup__input-box">
